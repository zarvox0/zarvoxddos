...
def banner():
 ...
 \_____/\_| |_/\_| \_| \___/  \___/ \_/ \_/
    """)
    print(Fore.CYAN + "      --- DDoS Tool --- By ZARVOX")
    print(Fore.WHITE + "------------------------------------------------")

def login():
    banner()
    print(Fore.YELLOW + " [1] Tool Login (ddos toolunu başlatır)")
    print(Fore.YELLOW + " [2] Setup (gerekli kütüphaneleri kurar)")
    print(Fore.YELLOW + " [3] Exit (tooldan çıkar)")
